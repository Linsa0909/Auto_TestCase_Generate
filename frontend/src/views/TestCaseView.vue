      ...
      <div class="flex flex-col gap-3 pt-5 border-t border-zinc-800/60">
        ...
        <div v-else class="flex flex-col gap-1.5 max-h-72 overflow-y-auto">
          <div
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-lg bg-zinc-900/50 border border-zinc-800/60 hover:border-zinc-600 hover:scale-[1.01] transition-all cursor-pointer group"
          ...
          >
            ...
            <Download class="w-4 h-4 text-zinc-600 group-hover:text-white transition-colors" :stroke-width="1.5" />
          </div>
        </div>
      </div>
    </aside>
    ...
    <section class="lg:col-span-8 flex flex-col gap-5">
      <div class="flex items-center justify-between pb-4 border-b border-zinc-800/60">
        <div class="flex items-center gap-3">
          <h2 class="text-xs text-zinc-400 uppercase tracking-wider font-medium">生成结果预览</h2>
